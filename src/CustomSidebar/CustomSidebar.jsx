  ...
  return (
    ...
    >
      <Menu>
        ...
        <div style={{ borderTop: "1px solid #cc781e", margin: "10px 10px" }} />
        <div style={{ flexDirection: "column", fontSize: 16, paddingTop: "5%" }}>
            <MenuItem onClick={() => onScreenChange(PageTypes.QuizPage)} icon={<FaFileAlt className={styles.sidebarIcons}/>} className={styles.sidebarButton}>Quizzes</MenuItem>
        </div>
      </Menu>
    </Sidebar>
  );
