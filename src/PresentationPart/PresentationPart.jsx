...
const PresentationPart = () => (
  <div className='flex-grow pt-15 pl-15'>
    <h1 className="text-5xl font-semibold tracking-tight text-nowrap text-neutral-100 sm:text-7xl">
    ...
    <ArrowedButton variant="secondary" className='w-50 h-10 text-xl mt-5 border-2 border-[rgba(33,33,33,1.0)]' unroundOnHover>
      Continue
    </ArrowedButton>
  </div>
);
