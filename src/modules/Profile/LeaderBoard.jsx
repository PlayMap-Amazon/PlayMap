      ...
      <table className={styles.table}>
        <tbody>
          {friends.map((friend, index) => {
            ...
            if (rank === 1) {
              rankContent = <img src="/rank1.png" alt="1st place" className={styles.medal} />;
            } else if (rank === 2) {
              rankContent = <img src="/rank2.png" alt="2nd place" className={styles.medal} />;
            } else if (rank === 3) {
              rankContent = <img src="/rank3.png" alt="3rd place" className={styles.medal} />;
            } else {
              rankContent = <span className={`${styles.rank} ${styles.normal}`}>{rank}</span>;
            }
